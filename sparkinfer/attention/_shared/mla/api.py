...
_MLA_STRATEGY_ENV = "SPARKINFER_MLA_PREFILL_STRATEGY"
_MLA_FORCE_SINGLE_PASS_ENV = "SPARKINFER_MLA_FORCE_SINGLE_PASS"
_MLA_FORCE_SPLIT_ENV = "SPARKINFER_MLA_FORCE_SPLIT"
...
def _run_sparse_mla(
    *,
    ...
    if _is_cuda_graph_capture_active(q_all.device):
        raise RuntimeError(
            "sparkinfer MLA would use the PyTorch reference during CUDA graph capture; "
