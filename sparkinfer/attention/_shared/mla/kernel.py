...
_MLA_SM120_NUM_SPLITS_ENV = "SPARKINFER_MLA_SM120_NUM_SPLITS"
...
_MLA_SM120_GLM_H8_NATIVE_ENV = "SPARKINFER_MLA_SM120_GLM_H8_NATIVE"
...
_MLA_SM120_DSV4_H16_NATIVE_ENV = "SPARKINFER_MLA_SM120_DSV4_H16_NATIVE"
...
def _env_num_splits_override() -> int:
    """Read ``SPARKINFER_MLA_SM120_NUM_SPLITS`` per call. ``<= 0`` / unset / bad -> 0
...
def plan_unified_decode_splits(
    *,
    ...
    Override precedence (highest first):
      ...
      2. ``SPARKINFER_MLA_SM120_NUM_SPLITS`` env (>=1 pins; <=0/unset -> heuristic).
...
@torch.library.custom_op(
    "sparkinfer::sparse_mla_sm120_decode_grid",
