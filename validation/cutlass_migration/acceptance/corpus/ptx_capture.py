...
while :func:`b12x._lib.compiler._store_cute_compile_to_disk` still has both the
...
_MANIFEST_SCHEMAS = frozenset(
    {"b12x._lib.compile_manifest.v3", "b12x.cute.compile_manifest.v3"}
)
...
def install() -> None:
    """Install PTX capture before the first corpus compile, preserving raw identity."""
    ...
    import b12x._lib.compiler as compiler
    ...
    # Retention controls remain in the raw identity. Only the independent
    # cross-toolchain comparison identity may normalize operational fields.
    ...
    _INSTALLATION_EVIDENCE = {
        ...
        "hook_target": "b12x._lib.compiler._store_cute_compile_to_disk",
    }
