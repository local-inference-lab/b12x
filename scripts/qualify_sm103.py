...
SUITES = {
    ...
    "trellis_moe": ["tests/moe/test_sm103_trellis_moe.py", "tests/moe/test_sm103_trellis_transforms.py"],
    "trellis_mixed": ["tests/moe/test_sm103_trellis_mixed_moe.py", "tests/moe/test_sm103_trellis_mixed_staging.py", "tests/moe/test_sm103_trellis_transforms.py", "-k", "mixed or prepared_expert_map"],
