...
TUNING = TuningContract(
    component_id="attention.dsa_indexer", query_schema_version=5, config_schema_version=4,
    ...
    candidate_contract_version=6, equivalence_key=_equivalence, parameters=_parameters,
