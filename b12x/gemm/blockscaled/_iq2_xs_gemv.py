...
from b12x._lib.intrinsics import get_ptr_as_int64, warp_reduce
...
@program_cache
def compile_gemv(ordinal, n, k, tile_m):
    ...
    with torch.cuda.device(ordinal):
        raw = b12x_compile(
            IQ2XSGemv(n, k, tile_m), *fake, Int32(1), current_cuda_stream(),
            compile_spec=KernelCompileSpec.from_key("gemm.iq2_xs.simt", 3, (ordinal, n, k, tile_m)),
        )
