...
class W4A16FusedMoeKernel:
    def __init__(
        ...
        *,
        ...
        self.fc2 = W4A16GemmKernel(
            ...
            single_token_route_fast_path=size_m == 1 and not self.direct_topk_routes,
            direct_topk_routes=self.direct_topk_routes,
            fused_topk_sum=(self.tc_decode_fused_sum and weight_layout not in BLOCK_CODECS),
    ...
    def _moe_body(
        ...
        if cutlass.const_expr(self.tc_decode_fused_sum and self.weight_layout not in BLOCK_CODECS):
