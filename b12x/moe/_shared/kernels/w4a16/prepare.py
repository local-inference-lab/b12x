...
class PreparedTrellis256DenseWeight:
    ...
    # The public dense planner binds a shape-, dtype-, and device-specific
    # cooperative launch during weight preparation. Runtime dispatch never
    # compiles or inserts a launch into process-global state.
