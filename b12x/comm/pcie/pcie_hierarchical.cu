...
#ifndef B12X_PCIE_HIERARCHICAL_NANOSLEEP_CYCLES
#define B12X_PCIE_HIERARCHICAL_NANOSLEEP_CYCLES 24
#endif

#ifndef B12X_PCIE_HIERARCHICAL_THREADS
#define B12X_PCIE_HIERARCHICAL_THREADS 224
#endif

#ifndef B12X_PCIE_HIERARCHICAL_BF16X2
#define B12X_PCIE_HIERARCHICAL_BF16X2 1
#endif

#ifndef B12X_PCIE_HIERARCHICAL_BF16X2_MAX_ELEMENTS
#define B12X_PCIE_HIERARCHICAL_BF16X2_MAX_ELEMENTS 7168
#endif

static_assert(B12X_PCIE_HIERARCHICAL_NANOSLEEP_CYCLES >= 0);
static_assert(B12X_PCIE_HIERARCHICAL_THREADS >= 32);
static_assert(B12X_PCIE_HIERARCHICAL_THREADS <= 1024);
static_assert(B12X_PCIE_HIERARCHICAL_THREADS % 32 == 0);
static_assert(
    B12X_PCIE_HIERARCHICAL_BF16X2 == 0 ||
    B12X_PCIE_HIERARCHICAL_BF16X2 == 1);
static_assert(B12X_PCIE_HIERARCHICAL_BF16X2_MAX_ELEMENTS >= 0);
...
constexpr int kScalarThreads = B12X_PCIE_HIERARCHICAL_THREADS;
...
__device__ __forceinline__ void wait_for(
  ...
  while (load_acquire(ptr) < generation) {
    ...
    B12X_PCIE_HIERARCHICAL_NANOSLEEP_CYCLES > 0
    __nanosleep(B12X_PCIE_HIERARCHICAL_NANOSLEEP_CYCLES);
#endif
  }
}
