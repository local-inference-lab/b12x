...
TUNING_COMPONENTS = (
    KernelTuningRegistration(op_qualname="moe.fused_moe", contract_ref="b12x.moe.fused_moe._routing_profile_tuning:TUNING", variant="routing_profile"),
    ...
    KernelTuningRegistration(op_qualname="moe.fused_moe", contract_ref="b12x.moe.fused_moe._cache_tuning:TUNING", variant="cache"),
