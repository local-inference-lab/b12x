...
def compile(
    ...
    **kwargs: Any,
    ...
    from .architecture import require_kernel_architecture
    from .gating import get_compute_capability

    require_kernel_architecture(
        getattr(func, "__module__", type(func).__module__), get_compute_capability()
    )
