...
def require_kernel_architecture(
    ...
    if module in {
        ...
        "b12x.sequence.mtp_feedback._cute_norm",
        ...
        "b12x.attention.compressed_sparse_mla._metadata",
        "b12x.attention.compressed_sparse_mla.cache_writer",
        "b12x.attention.compressed_sparse_mla.cast",
        "b12x.attention.compressed_sparse_mla.rotary",
        "b12x.attention.compressed_sparse_mla.weight_scale",
        "b12x.attention.sparse_mla._paged_index_remap",
