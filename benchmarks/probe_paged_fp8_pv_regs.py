...
def _dump_words(*, use_tma: bool) -> torch.Tensor:
    overrides = {
        "B12X_PAGED_KV_DEBUG_DUMP": "PVREGS",
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Compare raw FP8 PV operand registers for paged attention.")
    parser.add_argument("--show-lane", type=int, default=0)
    parser.add_argument("--show-words", type=int, default=16)
