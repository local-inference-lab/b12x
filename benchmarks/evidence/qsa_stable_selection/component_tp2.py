...
def main():
    report = {'status': 'research-only', 'scope': 'Isolated TP2 FP8 complete-QSA comparison, including state restoration in both graphs; exact same inputs and prepared kernels.', 'cases': []}
    for rows, context, kind in [(4, 8192, 'speculative'), (8, 8192, 'throughput'), (7520, 8192, 'prefill'), (7520, 65536, 'prefill'), (7520, 131072, 'prefill')]:
        ...
        case = harness.BenchmarkCase(harness.PROFILES['tp2'], rows, context, kind=kind,
                                     main_page_size=2848, planned_max_batch=16,
